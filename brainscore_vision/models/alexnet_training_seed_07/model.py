...
def get_model_list():
    return ['alexnet_training_seed_07']

def get_model(name):
    assert name == 'alexnet_training_seed_07'
    

    model = alexnet_v2_pytorch()

  
    weights_path = load_weight_file(bucket = "brainscorevariability", relative_path = "model_weights/training_seed_07.pth", version_id = None, sha1 = "1c8cf8cd9541da55e1488141305e028df2e0d652" )
    ...
    wrapper = PytorchWrapper(identifier='alexnet_training_seed_07', model=model, preprocessing=preprocessing)

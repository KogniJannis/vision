...
def get_model_list():
    return ['alexnet_training_seed_02']

def get_model(name):
    assert name == 'alexnet_training_seed_02'
    

    model = alexnet_v2_pytorch()

  
    weights_path = load_weight_file(bucket = "brainscorevariability", relative_path = "model_weights/training_seed_02.pth", version_id = None, sha1 = "4dd6fa8ed3edf7f505473e5006748781e47d5f37" )
    ...
    wrapper = PytorchWrapper(identifier='alexnet_training_seed_02', model=model, preprocessing=preprocessing)

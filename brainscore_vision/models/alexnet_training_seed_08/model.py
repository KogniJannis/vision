...
def get_model_list():
    return ['alexnet_training_seed_08']

def get_model(name):
    assert name == 'alexnet_training_seed_08'
    

    model = alexnet_v2_pytorch()

  
    weights_path = load_weight_file(bucket = "brainscorevariability", relative_path = "model_weights/training_seed_08.pth", version_id = None, sha1 = "f23baaa874655478c3639678a10bae721d37b875" )
    ...
    wrapper = PytorchWrapper(identifier='alexnet_training_seed_08', model=model, preprocessing=preprocessing)

...
def get_model_list():
    return ['alexnet_training_seed_03']

def get_model(name):
    assert name == 'alexnet_training_seed_03'
    

    model = alexnet_v2_pytorch()

  
    weights_path = load_weight_file(bucket = "brainscorevariability", relative_path = "model_weights/training_seed_03.pth", version_id = None, sha1 = "6c5a1fdadc70e5007c66866400bfcd7c17280fa8" )
    ...
    wrapper = PytorchWrapper(identifier='alexnet_training_seed_03', model=model, preprocessing=preprocessing)

...
def get_model_list():
    return ['alexnet_training_seed_09']

def get_model(name):
    assert name == 'alexnet_training_seed_09'
    

    model = alexnet_v2_pytorch()

  
    weights_path = load_weight_file(bucket = "brainscorevariability", relative_path = "model_weights/training_seed_09.pth", version_id = None, sha1 = "99da889e537c56df9984862d73751e23ecbdef82" )
    ...
    wrapper = PytorchWrapper(identifier='alexnet_training_seed_09', model=model, preprocessing=preprocessing)

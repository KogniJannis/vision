...
def get_model_list():
    return ['alexnet_training_seed_10']

def get_model(name):
    assert name == 'alexnet_training_seed_10'
    

    model = alexnet_v2_pytorch()

  
    weights_path = load_weight_file(bucket = "brainscorevariability", relative_path = "model_weights/training_seed_10.pth", version_id = None, sha1 = "c7cb4182b978d1667716bd0e0dc930e2412fb483" )
    ...
    wrapper = PytorchWrapper(identifier='alexnet_training_seed_10', model=model, preprocessing=preprocessing)

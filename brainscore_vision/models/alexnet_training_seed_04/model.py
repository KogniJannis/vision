...
def get_model_list():
    return ['alexnet_training_seed_04']

def get_model(name):
    assert name == 'alexnet_training_seed_04'
    

    model = alexnet_v2_pytorch()

  
    weights_path = load_weight_file(bucket = "brainscorevariability", relative_path = "model_weights/training_seed_04.pth", version_id = None, sha1 = "1659290229b7712ee450e6805f4a8a880ecb2a97" )
    ...
    wrapper = PytorchWrapper(identifier='alexnet_training_seed_04', model=model, preprocessing=preprocessing)

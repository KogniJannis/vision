...
def ridge_cv_regression(regression_kwargs=None, xarray_kwargs=None, alphas=ALPHA_LIST, gpu_enabled=True,  eigh_driver='evr'):
    ...
    if cuda.is_available() and gpu_enabled:
        ...
        regression_kwargs.pop('eigh_driver', None)
